...
function createTaskDispatch(deps = {}) {
 ...
 const { cadenceWakes, scheduleCadenceWake, clearCadenceWakes, reapCadenceWakes, awaitCadenceWake } =
  require('./cadence-wakes.cjs').createCadenceWakes({ getDb, continueConversation });
