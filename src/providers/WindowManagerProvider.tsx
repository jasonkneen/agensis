...
export function WindowManagerProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<WindowManagerValue>(
    () => ({ windows, openWindow, openSessionBeside, openSplitWindow, closeWindow, closeAllWindows, focusWindow, updateWindow, minimizeWindow, setWindowsMinimized, selectedWindowIds, setSelectedWindowIds, focusWindowGroup, minimizeWindowGroup, ungroupTiledWindows, viewMode, enterFullExpand, exitFullExpand, toggleFullExpand }),
    [windows, openWindow, openSessionBeside, openSplitWindow, closeWindow, closeAllWindows, focusWindow, updateWindow, minimizeWindow, setWindowsMinimized, selectedWindowIds, setSelectedWindowIds, focusWindowGroup, minimizeWindowGroup, ungroupTiledWindows, viewMode, enterFullExpand, exitFullExpand, toggleFullExpand],
  );
