...
const PUBLIC_TOOL_SURFACE = {
  ...
  grant_agent_permission_rule: ['agent_id', 'rule'],
  list_agents: [],
  list_agent_permission_rules: ['agent_id'],
  list_channels: [],
  ...
  reply_to_comment: ['comment_id', 'content'],
  ...
  revoke_agent_permission_rule: ['agent_id', 'rule'],
  search_docs: ['query'],
